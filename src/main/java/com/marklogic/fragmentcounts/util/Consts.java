...
public class Consts {
    ...
    public static String START = "2014-07-10";

    /*
    LOG.info(System.getProperty("user.dir"));
    StaticHttpHandler staticHttpHandler = new StaticHttpHandler("C:\\Users\\Alex\\workspace\\ml-fragment-counts\\src\\main\\resources\\vendor"); */
}
